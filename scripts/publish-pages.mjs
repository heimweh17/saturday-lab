...
function git(args,cwd=out){const r=spawnSync('git',args,{cwd,encoding:'utf8',env:{...process.env,GIT_TERMINAL_PROMPT:'0'}});if(r.status!==0)throw Error(r.stderr||r.stdout);return r.stdout.trim()}
