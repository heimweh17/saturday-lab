...
export type MatchupSeed={a:string;b:string;venue:'a'|'b'|'neutral';fixtureId?:string;date?:string;awayName?:string;homeName?:string;neutral?:boolean};
